import{u as e,j as s,s as i,L as n}from"./index-DQ3FoKqk.js";import{S as r}from"./SEOHead-ZmeIlSyn.js";import{u as l}from"./useAOS-CRA2ZcoE.js";const h=()=>{const{t:d}=e();return l(),s.jsxs(s.Fragment,{children:[s.jsx(r,{title:`자료구조란? - ${i.nameKo}`,description:"자료구조의 정의, 분류, 추상 자료형(ADT)의 개념과 자료구조 선택 기준을 학습합니다."}),s.jsx("div",{className:"page-header",children:s.jsx("div",{className:"container",children:s.jsxs("div",{className:"page-header-content","data-aos":"fade-up",children:[s.jsx("h1",{className:"page-title",children:"자료구조란?"}),s.jsx("p",{className:"page-subtitle",children:"데이터를 효율적으로 저장, 관리, 처리하기 위한 체계적인 구조를 학습합니다."})]})})}),s.jsx("div",{className:"lesson-content",children:s.jsx("div",{className:"container",children:s.jsxs("div",{className:"lesson-body","data-aos":"fade-up",children:[s.jsx("h2",{className:"lesson-subtitle",id:"definition",children:"자료구조의 정의"}),s.jsxs("p",{children:[s.jsx("strong",{children:"자료구조(Data Structure)"}),"란 데이터를 효율적으로 저장하고, 관리하며, 처리하기 위해 데이터를 조직화하는 방법을 의미합니다. 컴퓨터 과학에서 가장 핵심적인 개념 중 하나로, 프로그램의 성능과 효율성에 직접적인 영향을 미칩니다."]}),s.jsx("p",{children:"현실 세계에서 도서관의 책을 분류 체계에 따라 정리하듯이, 컴퓨터에서도 데이터를 특정 규칙과 구조에 따라 정리해야 빠르게 찾고, 수정하고, 삭제할 수 있습니다. 이러한 데이터의 조직화 방식이 바로 자료구조입니다."}),s.jsxs("div",{className:"callout-box",children:[s.jsx("strong",{children:"핵심 정의:"})," 자료구조는 데이터의 저장(Storage), 조직(Organization), 관리(Management)를 위한 형식이며, 효율적인 접근(Access)과 수정(Modification)을 가능하게 합니다."]}),s.jsxs("div",{className:"code-block",children:[s.jsx("div",{className:"code-header",children:s.jsx("span",{children:"Python - 자료구조의 기본 예시"})}),s.jsx("pre",{children:s.jsx("code",{children:`# 리스트(배열) - 순서가 있는 데이터 모음
fruits = ["사과", "바나나", "체리", "딸기"]
...
current_task = task_queue.popleft()  # "프린트 작업 1" (먼저 요청한 것 먼저 처리)`})})]}),s.jsxs("div",{className:"exercise-box",children:[s.jsx("h3",{className:"exercise-title",children:"연습 문제"}),s.jsxs("ol",{className:"exercise-list",children:[s.jsxs("li",{children:["다음 상황에 가장 적합한 자료구조를 선택하고 그 이유를 설명하세요:",s.jsxs("ul",{children:[s.jsx("li",{children:'웹 브라우저의 "뒤로 가기" 기능 구현'}),s.jsx("li",{children:"은행 창구의 대기 번호 시스템"}),s.jsx("li",{children:"회사의 조직도 표현"}),s.jsx("li",{children:"도시 간 도로망 표현"})]})]}),s.jsx("li",{children:"추상 자료형(ADT)과 자료구조의 차이를 설명하고, 큐(Queue) ADT의 핵심 연산을 나열해 보세요."}),s.jsx("li",{children:"선형 자료구조와 비선형 자료구조의 차이를 설명하고, 각각의 예시를 3가지씩 들어보세요."})]})]}),s.jsxs("div",{className:"lesson-nav",children:[s.jsx("div",{className:"lesson-nav-left"}),s.jsx("div",{className:"lesson-nav-right",children:s.jsx(n,{to:"/intro/complexity",className:"btn btn-primary",children:"다음: 시간/공간 복잡도 →"})})]})]})})})]})};export{h as default};
