...
const SelectionSort = (): React.ReactElement => {
  useAOS();
        ...
        <div className="container">
          <div className="lesson-body">
            ...
            <div className="callout-box">
              <h3>학습 목표</h3>
              <ul>
                <li>선택 정렬의 개념과 동작 원리를 이해한다.</li>
                <li>선택 정렬의 시간 복잡도와 교환 횟수를 분석한다.</li>
                <li>불안정 정렬의 특성을 이해한다.</li>
                <li>Python으로 선택 정렬을 구현할 수 있다.</li>
              </ul>
            </div>
...
결과: [10, 13, 14, 29, 37]`}</code></pre>
            ...
            <div className="callout-box">
              <h3>핵심 관찰</h3>
              <ul>
                <li>매 회전마다 정렬되지 않은 영역에서 최솟값을 찾아 현재 위치에 놓습니다.</li>
                <li>앞에서부터 하나씩 확정되어 나갑니다.</li>
              </ul>
            </div>
...
# 하지만 선택 정렬은 교환 과정에서 순서가 바뀔 수 있음`}</code></pre>
            ...
            <div className="callout-box">
              <h3>안정 정렬 vs 불안정 정렬</h3>
              <ul>
                <li>안정 정렬은 같은 키를 가진 요소의 원래 순서를 보장합니다.</li>
                <li>데이터베이스에서 여러 기준으로 정렬할 때 안정 정렬이 중요합니다.</li>
                <li>안정 정렬: 버블, 삽입, 병합 / 불안정 정렬: 선택, 퀵, 힙</li>
              </ul>
            </div>
...
selection_sort_verbose([29, 10, 14, 37, 13])`}</code></pre>
            ...
            <div className="lesson-nav">
              <Link to="/algorithm/bubble-sort" className="lesson-nav-btn prev">&larr; 버블 정렬</Link>
              <Link to="/algorithm/insertion-sort" className="lesson-nav-btn next">삽입 정렬 &rarr;</Link>
            </div>
