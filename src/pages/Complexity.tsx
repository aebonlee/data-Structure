...
const Complexity = (): React.ReactElement => {
  useAOS();
        ...
        <div className="container">
          <div className="lesson-body">
            ...
            <p>
              ...
              입력 크기가 증가함에 따라 <strong>어떻게 증가하는지</strong>를 나타냅니다.
            </p>
            <p>
              Big-O는 <strong>최악의 경우(Worst Case)</strong>의 성능을 표현하며,
              상수 계수와 낮은 차수의 항은 무시합니다. 이를 통해 알고리즘의 확장성을
              직관적으로 비교할 수 있습니다.
            </p>
            ...
            <div className="callout-box">
              ...
              <ul>
                ...
                <li>입력 크기가 충분히 클 때의 증가율에 집중한다</li>
              </ul>
            </div>
...
def has_duplicate(arr):
    ...
    return False`}</code></pre>
            ...
            <p>
              ...
              따라 달라지므로, 연산 횟수로 성능을 표현합니다.
            </p>
            <p>
              시간 복잡도를 분석할 때는 다음 세 가지 경우를 고려합니다:
            </p>
            <ul>
              <li><strong>최선의 경우 (Best Case) - &Omega;(오메가):</strong> 가장 빠르게 실행되는 경우</li>
              <li><strong>평균적인 경우 (Average Case) - &Theta;(세타):</strong> 일반적으로 기대되는 성능</li>
              <li><strong>최악의 경우 (Worst Case) - O(빅오):</strong> 가장 느리게 실행되는 경우</li>
            </ul>
            <p>
              일반적으로 알고리즘 분석에서는 <strong>최악의 경우(Big-O)</strong>를 기준으로
              성능을 평가합니다. 이를 통해 알고리즘의 성능 보장 하한선을 알 수 있기 때문입니다.
            </p>
...
print(f"O(n log n) : {t3:.6f}초")`}</code></pre>
            ...
            <p>
              ...
              중요하며, 특히 메모리가 제한된 환경에서는 공간 복잡도를 반드시 고려해야 합니다.
            </p>
            <p>
              공간 복잡도에는 다음 두 가지 요소가 포함됩니다:
            </p>
            <ul>
              <li>
                <strong>고정 공간:</strong> 입력 크기와 무관하게 필요한 공간 (변수, 상수 등)
              </li>
              <li>
                <strong>가변 공간:</strong> 입력 크기에 따라 달라지는 공간 (동적 배열, 재귀 호출 스택 등)
              </li>
            </ul>
...
#   방법 2: 약 100,000 연산 (O(n))`}</code></pre>
            </div>
...
# 해시맵으로 시간-공간 트레이드오프 활용!`}</code></pre>
            </div>
...
print(f"반복문:     fib({n}) = {fib_iterative(n)}, "
    ...
    return count`}</code></pre>
                ...
                <li>
                  O(n) 시간 복잡도와 O(n&sup2;) 시간 복잡도의 알고리즘이 있을 때,
                  n = 1,000,000인 경우 각각 대략 몇 번의 연산이 수행되는지 계산하세요.
                </li>
                <li>
                  다음 상황에서 시간-공간 트레이드오프를 설명하세요: 배열에서 중복 원소를
                  찾을 때 정렬을 사용하는 방법 vs 해시 집합을 사용하는 방법.
                </li>
                <li>
                  병합 정렬의 시간 복잡도가 O(n log n)인 이유를 재귀 트리를 그려서 설명하세요.
                </li>
              </ol>
            </div>
