...
const Home = (): React.ReactElement => {
  ...
  const curriculumCards: CurriculumCard[] = [
    { step: '01.', icon: '\u{1F4DA}', title: 'DS 개론', desc: '자료구조의 정의, 분류, 시간/공간 복잡도', path: '/intro/what-is-ds' },
    { step: '02.', icon: '\u{1F4CF}', title: '선형 자료구조', desc: '배열, 연결 리스트, 스택, 큐, 덱', path: '/linear' },
    { step: '03.', icon: '\u{1F333}', title: '비선형 자료구조', desc: '트리, 이진 트리, BST, 힙, 그래프', path: '/nonlinear' },
    { step: '04.', icon: '\u{1F511}', title: '해시 자료구조', desc: '해시 테이블, 해시 맵, 충돌 해결', path: '/hash' },
    { step: '05.', icon: '\u26A1', title: '알고리즘', desc: '정렬(버블, 선택, 삽입, 병합, 퀵), 탐색', path: '/algorithm' },
    { step: '06.', icon: '\u{1F680}', title: '고급 자료구조', desc: '트라이, 세그먼트 트리, 유니온 파인드', path: '/advanced' },
  ];
